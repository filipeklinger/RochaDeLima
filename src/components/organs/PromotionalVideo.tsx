    ...
    return (
        <section className="w-full min-h-sceen md:min-h-[1000px] relative pt-14">
            <div className="flex flex-col justify-center items-center">
                ...
                {PromotionalVideoTexts.paragraph && <Text as="p" className="text-amber-500 lg:text-sm text-xs tracking-widest uppercase font-medium">{PromotionalVideoTexts.paragraph}</Text>}
            </div>
            <div className="flex flex-col justify-center items-center pt-10 mb-5">
                <iframe className="w-3/4 aspect-video"
